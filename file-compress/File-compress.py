...
label4 = sg.Text(key = "output", text_color="Green", background_color= "White")

window = sg.Window("File compress", layout=[[label1, input1 , choose_btn], [label2, input2, choose_btn_2], [label3,txt_box],[compress_btn,label4]])
